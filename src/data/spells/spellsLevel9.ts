...
export const clericLevel9Spells: Spell[] = [
  ...
  },
  {
    ...
    "components": {
      "verbal": true,
      "somatic": true,
      "material": "un jaspe et une perle d'une valeur totale d'au moins 1000 po",
      "materialConsumed": false
    },
    "duration": {
      "type": "timed",
  ...
  },
  {
    ...
    "components": {
      "verbal": true,
      "somatic": true,
      "material": "de l'encens et des herbes",
      "materialConsumed": false
    },
    "duration": {
      "type": "timed",
  ...
  },
  {
    ...
    "components": {
      "verbal": true,
      "somatic": true,
      "material": "de l'encens et de l'or d'une valeur d'au moins 1000 po",
  ...
  },
  {
    ...
    "components": {
      "verbal": true,
      "somatic": true,
      "material": "des diamants d'une valeur d'au moins 25000 po",
      "materialConsumed": true
    },
    "duration": {
      "type": "instantaneous"
