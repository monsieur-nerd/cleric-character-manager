...
export const clericLevel2Components: SpellComponentMapping[] = [
  ...
  // Amélioration de caractéristique - Composants alternatifs : Poil OU Plume de bête
  {
    ...
    classSource: 'cleric',
    itemId: 'poil-bete',
    itemName: 'Poil de bête',
    quantity: 1,
    consumed: false,
    price: 1,
    priority: 'low',
    alternativeGroupId: 'enhance-ability-component',
    alternatives: [
      { itemId: 'plume-bete', itemName: 'Plume de bête', price: 1 },
    ],
  },
  {
    spellId: 'enhance-ability',
    ...
    alternativeGroupId: 'enhance-ability-component',
    alternatives: [
      { itemId: 'poil-bete', itemName: 'Poil de bête', price: 1 },
    ],
  },
  {
    spellId: 'augury',
