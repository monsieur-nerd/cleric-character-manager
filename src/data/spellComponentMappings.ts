...
export const clericLevel4Components: SpellComponentMapping[] = [
  ...
  // Divination - Composants multiples : Encens ET offrande
  {
    ...
    spellLevel: 4,
    classSource: 'cleric',
    itemId: 'encens-divination',
    itemName: 'Encens (Divination)',
    quantity: 1,
    consumed: true,
    price: 10,
    priority: 'high',
  },
  {
    ...
    spellLevel: 4,
    classSource: 'cleric',
    itemId: 'offrande-divination',
    itemName: 'Offrande (Divination)',
    quantity: 1,
    consumed: true,
    price: 15,
    priority: 'high',
...
export const clericLevel5Components: SpellComponentMapping[] = [
  ...
  // Communion - Composants multiples : Encens ET offrande
  {
    ...
    spellLevel: 5,
    classSource: 'cleric',
    itemId: 'encens-communion',
    itemName: 'Encens (Communion)',
    quantity: 1,
    consumed: true,
    price: 10,
    priority: 'high',
  },
  {
    ...
    spellLevel: 5,
    classSource: 'cleric',
    itemId: 'offrande-communion',
    itemName: 'Offrande (Communion)',
    quantity: 1,
    consumed: true,
    price: 15,
    priority: 'high',
  ...
  // Dissipation du mal/bien - Composants multiples : Eau bénite ET argent
  {
    ...
    spellLevel: 5,
    classSource: 'cleric',
    itemId: 'eau-bénite-dissipation',
    itemName: 'Eau bénite (Dissipation)',
    quantity: 1,
    consumed: false,
    price: 5,
    priority: 'high',
  },
  {
    ...
    spellLevel: 5,
    classSource: 'cleric',
    itemId: 'argent-dissipation',
    itemName: 'Argent (Dissipation)',
    quantity: 1,
    consumed: false,
    price: 5,
    priority: 'high',
  ...
  // Scrutation - Composants multiples : Encens ET miroir
  {
    ...
    spellLevel: 5,
    classSource: 'cleric',
    itemId: 'encens-scrutation',
    itemName: 'Encens (Scrutation)',
    quantity: 1,
    consumed: false,
    price: 200,
    priority: 'medium',
  },
  {
    ...
    spellLevel: 5,
    classSource: 'cleric',
    itemId: 'miroir-scrutation',
    itemName: 'Miroir (Scrutation)',
    quantity: 1,
    consumed: false,
    price: 800,
    priority: 'medium',
...
export const clericLevel6Components: SpellComponentMapping[] = [
  ...
  // Interdiction - Composants multiples : Eau bénite ET herbes
  {
    ...
    spellLevel: 6,
    classSource: 'cleric',
    itemId: 'eau-bénite-interdiction',
    itemName: 'Eau bénite (Interdiction)',
    quantity: 1,
    consumed: true,
    price: 5,
    priority: 'high',
  },
  {
    ...
    spellLevel: 6,
    classSource: 'cleric',
    itemId: 'herbes-interdiction',
    itemName: 'Herbes (Interdiction)',
    quantity: 1,
    consumed: true,
    price: 20,
    priority: 'high',
  ...
  // Trou de mémoire - Composants multiples : Encens ET plume
  {
    ...
    spellLevel: 6,
    classSource: 'cleric',
    itemId: 'encens-memoire',
    itemName: 'Encens (Trou de mémoire)',
    quantity: 1,
    consumed: false,
    price: 5,
    priority: 'low',
  },
  {
    ...
    spellLevel: 6,
    classSource: 'cleric',
    itemId: 'plume-memoire',
    itemName: 'Plume (Trou de mémoire)',
    quantity: 1,
    consumed: false,
    price: 5,
    priority: 'low',
...
export const clericLevel7Components: SpellComponentMapping[] = [
  ...
  // Contrôle du climat - Composants multiples : Encens ET eau
  {
    ...
    spellLevel: 7,
    classSource: 'cleric',
    itemId: 'encens-climat',
    itemName: 'Encens (Contrôle du climat)',
    quantity: 1,
    consumed: false,
    price: 5,
    priority: 'high',
  },
  {
    ...
    classSource: 'cleric',
    itemId: 'eau-climat',
    itemName: 'Eau (Contrôle du climat)',
    quantity: 1,
    consumed: false,
    price: 5,
    priority: 'high',
  ...
  // Dessin du profane - Composants multiples : Encens ET poudre d'os
  {
    ...
    spellLevel: 7,
    classSource: 'cleric',
    itemId: 'encens-profane',
    itemName: 'Encens (Dessin du profane)',
    quantity: 1,
    consumed: true,
    price: 50,
    priority: 'high',
  },
  {
    ...
    classSource: 'cleric',
    itemId: 'poudre-os',
    itemName: 'Poudre d\'os (Dessin du profane)',
    quantity: 1,
    consumed: true,
    price: 450,
    priority: 'high',
...
export const clericLevel9Components: SpellComponentMapping[] = [
  ...
  // Prémonition - Composants multiples : Encens ET herbes
  {
    ...
    spellLevel: 9,
    classSource: 'cleric',
    itemId: 'encens-premonition',
    itemName: 'Encens (Prémonition)',
    quantity: 1,
    consumed: false,
    price: 25,
    priority: 'high',
  },
  {
    ...
    spellLevel: 9,
    classSource: 'cleric',
    itemId: 'herbes-premonition',
    itemName: 'Herbes (Prémonition)',
    quantity: 1,
    consumed: false,
    price: 25,
    priority: 'high',
  ...
  // Déclaration divine - Composants multiples : Encens ET or
  {
    ...
    spellLevel: 9,
    classSource: 'cleric',
    itemId: 'encens-implosion',
    itemName: 'Encens (Déclaration divine)',
    quantity: 1,
    consumed: true,
    price: 50,
    priority: 'critical',
  },
  {
    ...
    classSource: 'cleric',
    itemId: 'or-implosion',
    itemName: 'Or (Déclaration divine)',
    quantity: 1,
    consumed: true,
    price: 950,
    priority: 'critical',
  ...
  // Apaisement - Composants multiples : Encens ET perle
  {
    ...
    spellLevel: 9,
    classSource: 'cleric',
    itemId: 'encens-apaisement',
    itemName: 'Encens (Apaisement)',
    quantity: 1,
    consumed: false,
    price: 50,
    priority: 'high',
  },
  {
    ...
    spellLevel: 9,
    classSource: 'cleric',
    itemId: 'perle-apaisement',
    itemName: 'Perle (Apaisement)',
    quantity: 1,
    consumed: false,
    price: 450,
    priority: 'high',
